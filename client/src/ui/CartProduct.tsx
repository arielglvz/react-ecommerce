  ...
  return (
    <div className='flex py-6 sm:py-10'>
      ...
      <div className='ml-4 flex flex-1 flex-col justify-between sm:ml-6'>
        <div className='relative pr-9 sm:grid md:grid-cols-4 sm:grid-cols-4 sm:gap-x-6 sm:pr-0'>
      ...
      <div>
        {product?.isStock && (<p className="mt-4 flex space-x-2 text-sm text-gray-700">
