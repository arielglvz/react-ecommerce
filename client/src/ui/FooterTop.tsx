...
const FooterTop = () => {
  const incentives = [
    ...
    },
    {
      ...
      imageSrc:
        "	https://cdn-icons-png.flaticon.com/512/7732/7732696.png",
      description:
    ...
    },
    {
      name: "Exchanges",
      imageSrc:
        "https://cdn-icons-png.flaticon.com/512/9284/9284376.png",
      description:
  ...
  return (
    <Container className='py-0'>
      <div className='rounded-2xl bg-[#f6f6f6] px-6 py-16 sm'>
