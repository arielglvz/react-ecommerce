  ...
  useEffect(() => {
    const getData = async () => {
      ...
      try {
        ...
        console.error("[Orders.tsx] Data fetching Error: ", error)
      } finally {
        setLoading(false);
      }
    }
        ...
        : orders?.length > 0 
          ? (
            <div className="max-w-5xl mx-auto">
              ...
              <p className="text-gray-600">Customer Name 
                            ...
                            <dt>
                              <DisclosureButton className="flex w-full items-center justify-between text-left text-gray-900 cursor-pointer">
                                <span className='text-base font-semibold leading-7'>
                                  Tracking numbers: 
                                  <span className='font-normal'>{order?.paymentId}</span>  {/* //! Nesting a span inside a span is not a good practice */}
                                </span>
                                <span>{ open ? <FaPlus /> : <FaMinus /> }</span>
                              </DisclosureButton>
                            </dt>
