          ...
          <div className="">
            <div className="border-b border-b-gray-300 pb-6">
              ...
              <p className='mt-2 text-sm text-gray-500 max-w-[500px] tracking-wide'>
                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quia, culpa repellat. 
                Saepe nobis mollitia tenetur omnis porro magni eum doloribus id, obcaecati repellendus explicabo cupiditate, 
                nulla nesciunt dignissimos modi reiciendis.
              </p>
            </div>
