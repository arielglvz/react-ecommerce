...
router.post('/checkout', async (req, res) => {
  ...
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      mode: 'payment',
      success_url: 'https://react-ecommerce-ho8r.vercel.app/success?session_id={CHECKOUT_SESSION_ID}', // http://localhost:5173/success?session_id={CHECKOUT_SESSION_ID}
      cancel_url: 'https://react-ecommerce-ho8r.vercel.app/cancel', // http://localhost:5173/cancel
      metadata: {
        email,
      }
    });
